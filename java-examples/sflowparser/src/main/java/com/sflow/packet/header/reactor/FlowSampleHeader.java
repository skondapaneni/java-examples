...
public class FlowSampleHeader {
     ...
     private long seqNumber; /* Incremented with each flow sample
     ...
     public static FlowSampleHeader parse(byte[] data, int offset, SFlowHeader sflowHeader) throws HeaderParseException {
          try {
               if (data.length - offset < 32) throw new HeaderParseException("Data array too short.");
               ...
               // input interface value (value of 0x3fffffff is special, it indicates packets
               ...
               sflowHeader.getCollector().getRawPacketRecordBus().notify(
                         FlowSampleHeaderConsumer.flowSampleHeaderEvent,
                    Event.wrap(efsh) );
